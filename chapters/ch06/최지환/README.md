...
> **source 구성**: 책 사진 15장(169~176쪽, 184~190쪽) + 문종운 님 정리본 [`README.md`](../문종운/README.md) + [메모리 생존 지도](../문종운/memory-survival-map.png) + [메모리 서베이 taxonomy 인포그래픽](./memory-survey-taxonomy-infographic.png)
> ⚠️ 177~183쪽(6-2 체크포인팅 절 본문)은 사진에 없음 — 복구 시나리오 결론부(184쪽)부터 확보.
